 ...
 */
public class SecureExtendedWebPage extends SecureWebPage {

	private static final long serialVersionUID = 1L;

	private static final org.apache.wicket.request.resource.ResourceReference baseCSS = new CssResourceReference(ExtendedWebPage.class, "base-style.css");
    
    private ModuleSelectorPanel selectorPanel;
    
    public SecureExtendedWebPage() {
        super();
        initLayout();
    }
