...
public class ImageManager {
    ...
    public static final ResourceReference IMAGE_WIZARD_COMMON_COLLAPSE = 
            new PackageResourceReference(ImageManager.class, "wizard/common/" + schemeDependentPrefix + "collapse.png");
    public static final ResourceReference IMAGE_WIZARD_COMMON_EXPAND = 
            new PackageResourceReference(ImageManager.class, "wizard/common/" + schemeDependentPrefix + "expand.png");
    public static final ResourceReference IMAGE_WIZARD_COMMON_SEARCH = 
            new PackageResourceReference(ImageManager.class, "wizard/common/search.png");
    public static final ResourceReference IMAGE_WIZARD_COMMON_ADD = 
    ...
    public static final ResourceReference IMAGE_WIZARD_DEVICE = 
