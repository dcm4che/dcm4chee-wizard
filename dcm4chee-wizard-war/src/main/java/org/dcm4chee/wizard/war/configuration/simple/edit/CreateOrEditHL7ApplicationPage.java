...
import org.dcm4chee.wizard.war.configuration.simple.validator.HL7NameValidator;
    ...
    public CreateOrEditHL7ApplicationPage(final ModalWindow window, final HL7ApplicationModel hl7ApplicationModel, 
        ...
        try {
			...
			for (Connection connection : ((DeviceModel) deviceNode.getModel()).getDevice().listConnections()) {
				...
				if 	(hl7ApplicationModel != null && hl7ApplicationModel.getHL7Application().getConnections().contains(connection))
        ...
        form.add(new Label("applicationName.label", new ResourceModel("dicom.edit.hl7-application.applicationName.label")))
        .add(new TextField<String>("applicationName", applicationNameModel)
        		.add(new HL7NameValidator(applicationNameModel.getObject()))
        ...
        optionalContainer.add(new Label("acceptedMessageTypes.label", 
        ...
        optionalContainer.add(new Label("acceptedSendingApplications.label", 
        ...
        optionalContainer.add(new Label("defaultCharacterSet.label", 
        ...
        optionalContainer.add(new Label("installed.label", new ResourceModel("dicom.edit.hl7-application.optional.installed.label")))
        ...
        form.add(new IndicatingAjaxButton("submit", new ResourceModel("saveBtn"), form) {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                try {
                	String oldName = hl7ApplicationModel == null ? null : hl7ApplicationModel.getHL7Application().getApplicationName();

                	HL7Application hl7Application = hl7ApplicationModel == null ? 
                			new HL7Application(applicationNameModel.getObject()) : (HL7Application) hl7ApplicationModel.getHL7Application();
