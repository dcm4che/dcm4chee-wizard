...
import org.dcm4chee.wizard.war.configuration.basic.validator.SOPClassValidator;
import org.dcm4chee.wizard.war.configuration.basic.validator.TransferCapabilityValidator;
import org.dcm4chee.wizard.war.configuration.basic.validator.TransferSyntaxValidator;
...
public class CreateOrEditTransferCapabilityPage extends SecureWebPage {
    ...
    public CreateOrEditTransferCapabilityPage(final ModalWindow window, final TransferCapabilityModel transferCapabilityModel, 
    		final TreeNode tcsNode, final TreeNode tcNode) {
    	super();
        ...
        form.add(new AjaxFallbackButton("submit", new ResourceModel("saveBtn"), form) {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                try {
                    ...
                    if (transferCapabilityModel == null)
                    	DeviceTreeProvider.get().addTransferCapability(tcsNode, transferCapability);
                    else {
