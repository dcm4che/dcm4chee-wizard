...
import org.dcm4chee.wizard.war.configuration.dicom.validator.TransferCapabilityValidator;
import org.dcm4chee.wizard.war.configuration.dicom.validator.TransferSyntaxValidator;
...
public class CreateOrEditTransferCapabilityPage extends SecureWebPage {
    ...
    public CreateOrEditTransferCapabilityPage(final ModalWindow window, final TransferCapabilityModel transferCapabilityModel, 
    		final ConfigurationTreeNode tcsNode, final ConfigurationTreeNode tcNode) {
    	super();
