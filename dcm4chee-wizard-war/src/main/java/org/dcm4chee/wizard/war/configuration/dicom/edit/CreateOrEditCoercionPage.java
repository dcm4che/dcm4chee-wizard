...
import org.dcm4chee.wizard.war.configuration.dicom.validator.RetrySuffixValidator;
...
public class CreateOrEditCoercionPage extends SecureWebPage {
    ...
    public CreateOrEditCoercionPage(final ModalWindow window, final CoercionModel coercionModel, 
    		final ConfigurationTreeNode rtsNode, final ConfigurationTreeNode rtNode) {
    	super();
        ...
        form.add(new AjaxFallbackButton("submit", new ResourceModel("saveBtn"), form) {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                try {
                    ...
                    if (coercionModel == null)
                    	DeviceTreeProvider.get().addCoercion(rtsNode, coercion);
                    else 
                    	DeviceTreeProvider.get().editCoercion(rtsNode, rtNode, coercion);
