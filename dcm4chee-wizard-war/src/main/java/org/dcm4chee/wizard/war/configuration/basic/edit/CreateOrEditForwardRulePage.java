...
import org.dcm4chee.wizard.war.configuration.basic.validator.CommonNameValidator;
import org.dcm4chee.wizard.war.configuration.basic.validator.DestinationURIValidator;
...
public class CreateOrEditForwardRulePage extends SecureWebPage {
    ...
    public CreateOrEditForwardRulePage(final ModalWindow window, final ForwardRuleModel frModel, 
    		final TreeNode frsNode, final TreeNode frNode) {
    	super();
