 ...
 */
public class ConnectionModel implements Serializable, ConfigurationNodeModel {
	...
	public ConnectionModel(Connection connection, int index) {
		this.deviceName = connection.getDevice().getDeviceName();
		this.index = index;
		this.connection = connection;
		
		this.commonName = connection.getCommonName();
	...
	public void rebuild(Device device) throws ConfigurationException {
		...
		if (connection == null) 
			connection = device.listConnections().get(index);
	}
}
