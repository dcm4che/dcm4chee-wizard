 ...
 */
public class CustomTreeColumn extends TreeColumn<TreeNode> {
	...
	@Override
	public void populateItem(Item<ICellPopulator<TreeNode>> cellItem, 
			String componentId, IModel<TreeNode> rowModel) {
