...
public class ApplyTransferCapabilityProfilePage extends SecureWebPage {
    ...
    public ApplyTransferCapabilityProfilePage(final ModalWindow window, final TransferCapabilityModel transferCapabilityModel, 
        ...
        form.add(groupDropDown
        		.setNullValid(false));

        form.add(new Label("profile.label", new ResourceModel("dicom.edit.transferCapability.profile.profile.label")));
        ...
        form.add(profileDropDown
        		.setNullValid(false)
        		.setEnabled(profileDropDown.getChoices().size() > 0));
        ...
        groupDropDown.add(new AjaxFormComponentUpdatingBehavior("onchange") {
            ...
            protected void onUpdate(AjaxRequestTarget target) {
        		...
        		profileDropDown
    				.setChoices(new ArrayList<Profile>());
