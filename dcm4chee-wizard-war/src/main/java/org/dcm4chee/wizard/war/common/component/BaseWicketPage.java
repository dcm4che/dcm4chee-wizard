...
public class BaseWicketPage extends WebPage {
	...
	private static final ResourceReference CSS = new PackageResourceReference(BaseWicketPage.class, "base-style.css");
    ...
    public void renderHead(IHeaderResponse response) {
    	if (BaseWicketPage.CSS != null)
    		response.renderCSSReference(BaseWicketPage.CSS);
    }
