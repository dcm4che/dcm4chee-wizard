...
public class DicomEchoPage extends SecureSessionCheckPage {
    ...
    public DicomEchoPage(final ModalWindow window, ApplicationEntity destinationAE) { 	
		...
		form.add(new IndicatingAjaxButton("echo", new ResourceModel("dicom.list.applicationEntity.echo.echoBtn.text"), form) {
		...
		form.add(new AjaxFallbackButton("cancel", new ResourceModel("dicom.list.applicationEntity.echo.cancelBtn.text"), form) {
