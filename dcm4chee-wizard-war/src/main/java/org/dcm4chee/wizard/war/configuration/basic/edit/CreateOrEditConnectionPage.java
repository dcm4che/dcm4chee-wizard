...
import org.dcm4chee.wizard.war.configuration.basic.validator.ConnectionValidator;
import org.dcm4chee.wizard.war.configuration.basic.validator.HostnameValidator;
...
public class CreateOrEditConnectionPage extends SecureWebPage {
    ...
    public CreateOrEditConnectionPage(final ModalWindow window, final ConnectionModel connectionModel, 
    		final TreeNode connectionsNode) {
        super();
