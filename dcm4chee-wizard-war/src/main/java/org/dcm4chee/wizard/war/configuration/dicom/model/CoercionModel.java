 ...
 */
public class CoercionModel implements Serializable, ConfigurationNodeModel {
	...
	private String coercionAETitle;
	private String sopClass;
	
	public CoercionModel(ProxyApplicationEntity applicationEntity, AttributeCoercion attributeCoercion) {
		this.aeTitle = applicationEntity.getAETitle();
		this.applicationEntity = applicationEntity;
		this.attributeCoercion = attributeCoercion;
		
		this.dimse = attributeCoercion.getDimse();
		this.transferRole = attributeCoercion.getRole();
		this.coercionAETitle = attributeCoercion.getAETitle();
		this.sopClass = attributeCoercion.getSopClass();
	}
	...
	private void rebuild(ProxyApplicationEntity applicationEntity) throws ConfigurationException {
		...
		if (attributeCoercion == null)
			attributeCoercion = applicationEntity.getAttributeCoercion(coercionAETitle, sopClass, transferRole, dimse);
	}
}
