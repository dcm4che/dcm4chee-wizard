...
public class ConfigTreeNode implements Serializable, Comparable<ConfigTreeNode> {
	...
	public enum TreeNodeType {
		...
		HL7_APPLICATION, AUDIT_LOGGER, FORWARD_RULE, FORWARD_OPTION, RETRY, COERCION, // proxy values
	...
	public ConfigTreeNode(ConfigTreeNode parent, StringResourceModel nameResource, TreeNodeType type, ConfigNodeModel model)	{
