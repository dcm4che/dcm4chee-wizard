...
public class XdsStorageModel extends ConfigNodeModel implements Serializable{

    private static final long serialVersionUID = 1L;

    public static String cssClass = "xds";
    public static String toolTip = "Xds storage";
    ...
    public void setStorageConfig(StorageConfiguration storageConfig) {
        this.storageConfig = storageConfig;
    }

    public XdsStorageModel(StorageConfiguration storageConfig) {
        this.storageConfig = storageConfig;
    }
