...
public class DeviceModel extends ConfigNodeModel implements Serializable {
    ...
    private void setApplicationEntities(Collection<ApplicationEntity> applicationEntities)
        ...
        for (Iterator<ApplicationEntity> i = applicationEntities.iterator(); i.hasNext();) {
            ...
            this.applicationEntities.put(applicationEntity.getAETitle(), new ApplicationEntityModel(applicationEntity));
        }
    }

    @Override
    public String getDescription() {
        return device == null || device.getDescription() == null ? toolTip + " " + deviceName : device.getDescription();
    }
}
